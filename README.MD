...
| eCommerce Service | http://localhost | 8083 |
...
* Additionally, Springfox generated Swagger documentation is available for each service, with exception of the Integration Service under `/swagger`
