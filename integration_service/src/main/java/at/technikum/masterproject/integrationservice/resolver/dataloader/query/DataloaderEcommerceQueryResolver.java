...
public class DataloaderEcommerceQueryResolver implements GraphQLQueryResolver {
  ...
  public CompletableFuture<Purchase> purchase(Long purchaseId, DataFetchingEnvironment environment) {
    log.debug("Retrieved purchase query for purchaseId {}, resolving using dataloader", purchaseId);
    DataLoader<Long, Purchase> dataLoader = environment.getDataLoader(PURCHASE_BY_ID_DATALOADER);
